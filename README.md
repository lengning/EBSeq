...
## Can I look at TPMs/RPKMs across samples?

It is not appropriate to perform cross sample comparisons using TPM, FPKM or RPKM without further normalization.
...
Based on TPM/FPKM/RPKM, an investigator may infer that first 4 genes are down-regulated and the 5th gene is up-regulated.
